...
export default function AuthPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert(
      `${isSignUp ? "Sign up" : "Log in"} with: ${email} (Supabase not connected yet)`
    );
  };
  ...
  return (
    <div className="mx-auto max-w-md px-4 py-16">
      <div className="rounded-xl border border-border bg-card p-8">
        ...
        {/* Google sign in */}
        <button className="mb-4 flex w-full items-center justify-center gap-2 rounded-lg border border-border px-4 py-2.5 text-sm font-medium transition-colors hover:bg-background">
